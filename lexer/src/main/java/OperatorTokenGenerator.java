...
public class OperatorTokenGenerator implements TokenGenerator {
    ...
    public TokenGeneratorResult read(LexicalRangeState lexicalRangeState, String input){
        ...
        Token token= new Token(DefaultTokenTypes.OPERATOR, index,index,new LexicalRange(lexicalRangeState.getColumn(), lexicalRangeState.getLine(), lexicalRangeState.getColumn(), lexicalRangeState.getLine()));
        LexicalRangeState newState= lexicalRangeState.updateState(index+1, lexicalRangeState.getLine(), lexicalRangeState.getColumn()+1);
        //return token;
