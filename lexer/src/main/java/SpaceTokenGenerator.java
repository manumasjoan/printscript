...
public class SpaceTokenGenerator implements TokenGenerator {
    ...
    public TokenGeneratorResult read(LexicalRangeState lexicalRangeState, String input) {
        ...
        Token token= new Token(DefaultTokenTypes.SPACE, index,index,new LexicalRange(lexicalRangeState.getColumn(), lexicalRangeState.getLine(), lexicalRangeState.getColumn(), lexicalRangeState.getLine()));

        LexicalRangeState newState= lexicalRangeState.updateState(lexicalRangeState.getIndex()+1, lexicalRangeState.getLine(), lexicalRangeState.getColumn()+1);
