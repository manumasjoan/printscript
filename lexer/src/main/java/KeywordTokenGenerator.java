...
public class KeywordTokenGenerator implements TokenGenerator {
    ...
    public TokenGeneratorResult read(LexicalRangeState lexicalRangeState, String input){
        ...
        Token token= new Token(DefaultTokenTypes.KEYWORD, index,index+keyword.length()-1,new LexicalRange(lexicalRangeState.getColumn(), lexicalRangeState.getLine(), lexicalRangeState.getColumn()+keyword.length()-1, lexicalRangeState.getLine()));
        LexicalRangeState newState= lexicalRangeState.updateState(index+keyword.length(), lexicalRangeState.getLine(), lexicalRangeState.getColumn()+keyword.length());
