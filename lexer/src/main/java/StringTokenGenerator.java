...
public class StringTokenGenerator implements TokenGenerator {
    ...
    public TokenGeneratorResult read(LexicalRangeState lexicalRangeState, String input) {
        ...
        if(!startsWithQuoteMarks(lexicalRangeState, input)) return new TokenGeneratorResult(lexicalRangeState);
    ...
    private TokenGeneratorResult createToken(LexicalRangeState lexicalRangeState, String input) {
        ...
        Token token= new Token(DefaultTokenTypes.LITERAL, index, index + string.length()-1, new LexicalRange(lexicalRangeState.getColumn(), lexicalRangeState.getLine(), lexicalRangeState.getColumn()+string.length()-1, lexicalRangeState.getLine()));
    ...
    private LexicalRangeState updateState(LexicalRangeState lexicalRangeState, int index, int closingQuoteMark) {
        return lexicalRangeState.updateState(index + closingQuoteMark +2, lexicalRangeState.getLine(), lexicalRangeState.getColumn()+ closingQuoteMark +2);
    }
