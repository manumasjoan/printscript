...
public class NumberTokenGenerator implements TokenGenerator {
    ...
    public TokenGeneratorResult read(LexicalRangeState lexicalRangeState, String input) {
        ...
        Token token= new Token(DefaultTokenTypes.LITERAL, index,index+number.length()-1,new LexicalRange(lexicalRangeState.getColumn(), lexicalRangeState.getLine(), lexicalRangeState.getColumn()+number.length()-1, lexicalRangeState.getLine()));
        LexicalRangeState newState= lexicalRangeState.updateState(index+number.length(), lexicalRangeState.getLine(), lexicalRangeState.getColumn()+number.length());
        //return token;
