...
public class LexerBuilder {
  ...
  public Lexer buildLexer_V10() {
    ...
    KeywordTokenGenerator keywordTokenGenerator =
        new KeywordTokenGenerator(List.of("let", "println"));
    OperatorTokenGenerator operatorTokenGenerator =
        new OperatorTokenGenerator(List.of("+", "-", "*", "/"));
    SeparatorTokenGenerator separatorTokenGenerator =
        new SeparatorTokenGenerator(List.of("(", ")", ";", ":"));
    ...
    List<TokenGenerator> tokenGenerators =
        List.of(
            ...
            spaceTokenGenerator,
            skipLineTokenGenerator,
            keywordTokenGenerator,
            operatorTokenGenerator,
            assignationTokenGenerator,
            identifierTokenGenerator,
            separatorTokenGenerator);
  ...
  public Lexer buildLexer_V11() {
    AssignationTokenGenerator assignationTokenGenerator =
        new AssignationTokenGenerator(List.of("="));
    KeywordTokenGenerator keywordTokenGenerator =
        new KeywordTokenGenerator(List.of("let", "println", "const", "if", "else", "readInput"));
    OperatorTokenGenerator operatorTokenGenerator =
        new OperatorTokenGenerator(List.of("+", "-", "*", "/"));
    SeparatorTokenGenerator separatorTokenGenerator =
        new SeparatorTokenGenerator(List.of("(", ")", "{", "}", ";", ":"));
