...
public class IdentifierTokenGenerator implements TokenGenerator {
    ...
    public TokenGeneratorResult read(LexicalRangeState lexicalRangeState, String input) {
        ...
        Token token= new Token(DefaultTokenTypes.IDENTIFIER, index,index+identifier.length()-1,new LexicalRange(lexicalRangeState.getColumn(), lexicalRangeState.getLine(), lexicalRangeState.getColumn()+identifier.length()-1, lexicalRangeState.getLine()));
        LexicalRangeState newState= lexicalRangeState.updateState(index+identifier.length(), lexicalRangeState.getLine(), lexicalRangeState.getColumn()+identifier.length());
        //return token;
